...
<template>
  ...
  <div
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">{{ user?.firstName + ' ' + user?.lastName }}
        </h3>
        <p class="font-medium text-gray-600 dark:text-gray-400">Admin</p>
        <div
        ...
        <div class="mx-auto max-w-180">
          ...
          <p class="mt-4.5 text-sm font-normal text-gray-600 dark:text-gray-400">
          ...
          <h5 class="mt-4 text-lg font-bold text-black dark:text-white">{{ userData?.firstName }} {{ userData?.lastName }}</h5>
          <p class="text-gray-600 dark:text-gray-400">{{ userData?.gender }}, {{ userData?.age }} years old</p>
          
          <ul class="mt-4 space-y-2 text-sm font-normal text-gray-600 dark:text-gray-400">
            <li><strong>Email:</strong> {{ userData?.email }}</li>
            <li><strong>Phone:</strong> {{ userData?.phone }}</li>
            <li><strong>Address:</strong> {{ userData?.address.address }}, {{ userData?.address.city }}, {{ userData?.address.state }} ({{ userData?.address.postalCode }})</li>
            <li><strong>Country:</strong> {{ userData?.address.country }}</li>
            <li><strong>Company:</strong> {{ userData?.company.name }} ({{ userData?.company.department }})</li>
            <li><strong>Job Title:</strong> {{ userData?.company.title }}</li>
            <li><strong>Education:</strong> {{ userData?.university }}</li>
