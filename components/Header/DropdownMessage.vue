    ...
    >
      ...
      <ul class="flex h-auto flex-col overflow-y-auto">
        <template v-for="(item, index) in messagesList" :key="index">
          <li>
            <router-link
              class="flex gap-4.5 border-t border-stroke px-4.5 py-2 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
              :to="item.route"
            >
              ...
              <div>
                ...
                <p class="text-sm text-black dark:text-white">{{ item.message }}</p>
